...
<header
	class="bg-dark-green text-very-light-green fixed top-0 flex w-full items-center justify-between px-6 py-4 font-mono shadow-lg z-10 "
>
	<div class="flex items-center space-x-4">
		<span class="text-light-green glow-effect text-2xl font-bold tracking-widest"> HostPro </span>
	</div>
	...
	<div class="md:hidden">
		<button class="text-light-green"> ☰ </button>
	</div>
</header>
